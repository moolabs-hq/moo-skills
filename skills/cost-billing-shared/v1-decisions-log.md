...
| 9 | Skill C customer-facing exposure | **Engineering-internal only v1.** Aggregated per-customer reports (Phase 2 outputs) shared on-request. **No public dashboard.** | Doc 3 Appendix B Q5 — public exposure of attribution accuracy is a trust mechanism but premature pre-GA. | After GA + 3+ customer pattern validation. |
